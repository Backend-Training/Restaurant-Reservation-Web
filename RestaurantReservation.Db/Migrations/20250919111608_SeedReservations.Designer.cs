...
namespace RestaurantReservation.Db.Migrations
{
    ...
    [Migration("20250919111608_SeedReservations")]
            ...
            modelBuilder.Entity("RestaurantReservation.Db.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = 1,
                            PartySize = 2,
                            ReservationDate = new DateTime(2025, 9, 20, 14, 16, 7, 287, DateTimeKind.Local).AddTicks(5139),
                            RestaurantId = 1,
                            TableId = 1
                        },
                        new
                        {
                            ...
                            CustomerId = 2,
                            PartySize = 4,
                            ReservationDate = new DateTime(2025, 9, 21, 14, 16, 7, 289, DateTimeKind.Local).AddTicks(8489),
                            RestaurantId = 2,
                            TableId = 2
                        },
                        new
                        {
                            ...
                            CustomerId = 3,
                            PartySize = 2,
                            ReservationDate = new DateTime(2025, 9, 22, 14, 16, 7, 289, DateTimeKind.Local).AddTicks(8513),
                            RestaurantId = 3,
                            TableId = 3
                        },
                        new
                        {
                            ...
                            CustomerId = 4,
                            PartySize = 3,
                            ReservationDate = new DateTime(2025, 9, 23, 14, 16, 7, 289, DateTimeKind.Local).AddTicks(8517),
                            RestaurantId = 4,
                            TableId = 4
                        },
                        new
                        {
                            ...
                            CustomerId = 5,
                            PartySize = 6,
                            ReservationDate = new DateTime(2025, 9, 24, 14, 16, 7, 289, DateTimeKind.Local).AddTicks(8519),
                            RestaurantId = 5,
                            TableId = 5
                        });
                });
